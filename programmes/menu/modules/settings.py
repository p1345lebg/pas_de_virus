...
class MenuSettings:
    def __init__(self, screen) -> None:
        ...
        self.buttons = [
            ...
            Button(screen,(40,35,'center'),(2,(1,1)),['settings','mouseSize',(20,20)],os.sep.join(['assets','mouse','triangle.png']),None,'',(0,0,0)),
            Button(screen,(50,35,'center'),(4,(1,1)),['settings','mouseSize',(40,40)],os.sep.join(['assets','mouse','triangle.png']),None,'',(0,0,0)),
            Button(screen,(60,35,'center'),(6,(1,1)),['settings','mouseSize',(60,60)],os.sep.join(['assets','mouse','triangle.png']),None,'',(0,0,0)),
            #FPS settings
