...
class MenuSettings:
    def __init__(self, screen) -> None:
        ...
        self.buttons = [
            ...
            Button(screen,(36,70,'center'),(7.5,(1,1)),['settings','windowSize',(960,540)],os.sep.join(['assets','buttons','main_button_unpressed_01.png']),os.sep.join(['assets','buttons','main_button_pressed_01.png']),'960x540',(0,0,0)),
            Button(screen,(46,70,'center'),(7.5,(1,1)),['settings','windowSize',(1920,1080)],os.sep.join(['assets','buttons','main_button_unpressed_01.png']),os.sep.join(['assets','buttons','main_button_pressed_01.png']),'1920x1080',(0,0,0)),
            Button(screen,(56,70,'center'),(7.5,(1,1)),['settings','windowSize',(3840,2160)],os.sep.join(['assets','buttons','main_button_unpressed_01.png']),os.sep.join(['assets','buttons','main_button_pressed_01.png']),'3840x2160',(0,0,0)),
            Button(screen,(66,70,'center'),(7.5,(1,1)),['settings','windowSize',(3840,2160)],os.sep.join(['assets','buttons','main_button_unpressed_01.png']),os.sep.join(['assets','buttons','main_button_pressed_01.png']),'Full Screen',(0,0,0)),
